    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            for (Cart cartItem : blist) {
                ...
                String status = bookDAOImpl.getBookStatus(bid); // Assuming you have a method to get the status from the book_dtls table
            ...
            if (!allBooksActive) {
                session.setAttribute("inactiveBook", "The following books in your cart are out of stock: " + inactiveBooks);
