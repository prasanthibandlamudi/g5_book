        ...
        <div class="col-md-6 p-5 border text-center" style="background-color: rgba(255, 255, 255, 0.7);">
            ...
            <div class="row d-flex justify-content-around">
							...
							<%
							    ...
							    %>
							   <a href="cart?bid=<%=b.getBookId()%>&uid=<%=u.getId()%>&returnTo=view_books.jsp?bid=<%= b.getBookId()%>" class="btn btn-danger btn-sm mr-1"><i class="fa-solid fa-cart-plus fa-2xs"></i> Add Cart</a>
